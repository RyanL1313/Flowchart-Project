...
public class FlowchartMain {
    public static void main(String[] args) throws IOException {
        ...
        DegreeCompletion degreeCompletion = new DegreeCompletion();
        degreeCompletion.setMajor("Computer Science Major");
        degreeCompletion.setMinor("N/A Minor");

        degreeCompletion.setCoursesNeededToGraduate();
        degreeCompletion.setCoursesRequiredByMajorAndOrMinorAndNonSpecificCoursesRequiredByMajorAndOrMinor();

        for(int i = 0; i < degreeCompletion.getCoursesRequiredByMajorAndOrMinor().size(); i++) {
            System.out.println(degreeCompletion.getCoursesRequiredByMajorAndOrMinor().get(i));
        }
